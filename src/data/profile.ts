    ...
    roles: [
      {
        ...
        points: [
          'Architected and maintains the production frontend for Dentally Assist, an AI call management project under the Appointlo SaaS platform for dental practices with inline audio playback, dual-mode analytics, and PDF blob exports.',
    ...
    roles: [
      {
        ...
        skills: ['JavaScript', 'HTML5', 'CSS3', 'Bootstrap', 'React.js', 'Git', 'GitHub'],
      },
    ],
  },
];
...
export const PROJECTS: Project[] = [
  {
    ...
    category: 'Appointlo SaaS · Dental AI Telephony',
    year: '2026',
    description:
      'A specialized clinical telephony project of the Appointlo SaaS platform. Multi-role internal dashboard giving dental practices complete visibility into their AI phone assistant, with inline audio playback, dual-mode analytics, appointment outcome tracking, and PDF reports.',
...
export const SKILL_GROUPS: SkillGroup[] = [
  ...
  },
  {
    ...
    items: ['Ant Design 6', 'Styled Components', 'Tailwind CSS', 'Bootstrap', 'shadcn/ui', 'Framer Motion', 'Responsive Design', 'Dark Mode Theming'],
  },
  {
